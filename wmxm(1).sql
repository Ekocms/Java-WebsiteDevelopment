...
CREATE TABLE `order_detail`  (
  ...
  `dish_id` bigint(0) DEFAULT NULL COMMENT '菜品id',
  `setmeal_id` bigint(0) DEFAULT NULL COMMENT '套餐id',
...
CREATE TABLE `setmeal`  (
  ...
  `status` int(0) DEFAULT NULL COMMENT '状态 0:停用 1:启用',
...
CREATE TABLE `user`  (
  ...
  `status` int(0) DEFAULT 0 COMMENT '状态 0:禁用，1:正常',
  PRIMARY KEY (`id`) USING BTREE
